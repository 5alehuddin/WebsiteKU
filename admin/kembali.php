...
if ($id_trans == "" || $judul == "") {
    ...
    $us = mysqli_query($conn, "UPDATE trans_pinjam SET status='kembali' WHERE id='$id_trans'") or die("Gagal update" . mysqli_error());
    $uj = mysqli_query($conn, "UPDATE data_buku SET jum_temp=(jum_temp+1) WHERE judul='$judul'") or die("Gagal update" . mysqli_error());
