...
<head>
    ...
    <meta name="description" content="Ruang Baca">
    <meta name="keywords" content="Cerita, Membaca, Online, Website">
...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
	...
	popupWindow = window.open(url,winName,settings)
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di aplikasi Ruang Baca, Silahkan menikmati cerita cerita yang anda inginkan. Untuk tombol Login Admin silahkan klik icon user atau bisa klik
        <a href="login.html">disini</a></b>
          </div>
            </div>
                        ...
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  ...
                                  <option> -- Pilih Salah Satu --</option>
                                  <option value="R6R"> R6R</option>
                                  <option value="R6S"> R6S</option>
                                  <option value="R6T"> R6T</option>
                                  <option value="R6U"> R6U</option>
                                  <option value="R6V"> R6V</option>
                                  <option value="R6W"> R6W</option>
                                  <option value="R6X"> R6X</option>
                                  <option value="R6Y"> R6Y</option>
                                  <option value="R6Z"> R6Z</option>
                                  </select>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk aplikasi Ruang Baca" cols="25"></textarea>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      Ruang Baca adalah aplikasi untuk menyediakan tempat bagi pengguna lainnya membaca cerita - cerita yang tersedia, aplikasi Ruang Baca dibuat oleh:
      <table>
      <tr>
      <td>Nama</td> <td>:</td> <td>Muhammad Hilman Saputra</td>
      </tr>
      <br />
      <tr>
      <td>Kelas</td> <td>:</td> <td>R6V</td>
      </tr>
      <tr>
      <td>NPM</td> <td>:</td> <td>201943501795</td>
      </tr>
      <tr>
      <td>No.Telp</td> <td>:</td> <td>0821 2720 8050</td>
      </tr>
      </table>
      </div>
