...
$.extend( $.validator, {
	...
	defaults: {
		...
		onclick: function( element ) {			if ( element.name in this.submitted ) {
				this.element( element );
	...
	prototype: {
		...
		init: function() {
			...
			$( this.currentForm )
				.validateDelegate( ":text, [type='password'], [type='file'], select, textarea, " +
					...
					"focusin focusout keyup", delegate)				.validateDelegate("select, option, [type='radio'], [type='checkbox']", "click", delegate);
		...
		showLabel: function( element, message ) {
			...
			if ( error.length ) {				error.removeClass( this.settings.validClass ).addClass( this.settings.errorClass );				error.html( message );
			} else {				error = $( "<" + this.settings.errorElement + ">" )
